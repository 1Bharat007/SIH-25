      ...
      <main className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8 space-y-8">
        ...
        {activeTab === 'evacuation' && (
          <div className="space-y-6">
            ...
            <div className="flex gap-2 overflow-x-auto pb-2">
              {[
                { type: 'landslide' as DisasterType, label: '🏔️ Landslide & Rockfall' },
                { type: 'flash_flood' as DisasterType, label: '🌊 Teesta GLOF & Flash Flood' },
                { type: 'earthquake' as DisasterType, label: '⚡ Seismic Earthquake' },
                { type: 'heavy_snowfall' as DisasterType, label: '❄️ Blizzard & Snow Stranding' },
              ].map((item) => (
                <button
                  key={item.type}
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pl-8 pt-2">
                          <div className="p-3 rounded-xl bg-emerald-950/30 border border-emerald-500/20 text-xs">
                            <strong className="text-emerald-300 block mb-1">✅ DO:</strong>
                          ...
                          <div className="p-3 rounded-xl bg-rose-950/30 border border-rose-500/20 text-xs">
                            <strong className="text-rose-300 block mb-1">❌ DON’T:</strong>
        ...
        {/* TAB 4: EMERGENCY SHELTERS & RELIEF CAMPS */}
        {activeTab === 'shelters' && (
          <div className="space-y-6">
            <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-950/60 via-slate-900 to-slate-950 border border-purple-500/30">
              <h3 className="text-lg font-bold text-white flex items-center gap-2">
                <Building2 className="w-5 h-5 text-purple-400" />
                Designated Disaster Shelters & Relief Camps
              </h3>
              <p className="text-xs text-white/70 mt-1 max-w-2xl">
                Official disaster assembly points and trauma centers equipped with backup power generators, medical triage, and satellite communications.
              </p>
            </div>
                ...
                >
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1 text-xs text-white/70">
                      ...
                      <p className="text-[11px] text-white/50 pl-5">⛰️ Altitude: {shelter.altitudeMeters} m</p>
                    </div>
